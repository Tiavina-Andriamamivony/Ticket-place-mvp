...
export function MyGlobe() {
    return (
      <div className="relative flex size-full max-w-3xl items-center justify-center overflow-hidden rounded-lg border bg-background px-40 pb-40 pt-8 md:pb-60 ">
        ...
        Join thousands worldwide, experiencing events without borders.
        </span>
